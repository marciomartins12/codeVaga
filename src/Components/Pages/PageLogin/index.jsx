    ...
    return (
        <>
            <div className={Style.container} id="container">
                <div className={`${Style.formcontainer} ${Style.singnup}`}>
                    <form>
                ...
                <div className={Style.togglecontainer}>
                    <div className={Style.toggle}>
                        <div className={`${Style.togglepanel} ${Style.toggleleft}`}>
                            ...
                            <button className={Style.hidden} id="login">Sign In</button>
                        </div>
                        <div className={`${Style.togglepanel} ${Style.toggleright}`}>
                            <h1>Hello, Friend!</h1>
                            <p>Register with your personal details to use all of site features</p>
                            <button className={Style.hidden} id="register">Sign Up</button>
                        </div>
                    </div>
                </div>
            </div>
